...
import './screen.css';
import { BuildOutlined,BookFilled, } from '@ant-design/icons';
...
class App extends Component {
  ...
  render() {
    return (
      <Router>
        <Layout>
          <Header className="header" style={{backgroundColor:"#F4D03F " ,height: "200px" }}>
            <div className="headertext">
              <label><BuildOutlined style={{color:"#000000",fontSize:"120px", marginRight:"30px"}}/><h2 style={{color:"#000000"}}>Numerical Method</h2></label>
            </div>
          </Header>
          <Layout>
            <Header className="header" style={{ backgroundColor:"#F4D03F" ,color:"000000"}}>
              <Menu theme="white" mode="horizontal" style={{color:"000000"}} >
          ...
          <Footer style={{ backgroundColor: "#F4D03F ", minHeight: 120 }}>
            <p style={{ fontSize: "20px", color: "#000000 "}}>
              © All Right Reserved<br />

              <p style={{fontSize:"22px", verticalAlign:"text-bottom"}}><BookFilled style={{ fontSize: "30px" }} /><a target="_blank" rel="noopener noreferrer" href="http://cs.kmutnb.ac.th/" style={{ color: "#000000 ", textDecoration: "none" }}> Department of Computer and Information Science - King Mongkut's University of Technology North Bangkok</a></p>
              <p >Made by Panita Kaewsidaeng</p>
            </p>
          </Footer>
        </Layout>
      </Router>
